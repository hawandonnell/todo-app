      ...
      <div class="group-list__inner">
        <div class="group-list__form">
          <Icon
            ...
            color="#888"
            height="24"
            @click="toggleGroupInputActive(), (isChangeGroupState = false)"
          />
          <form
            v-on:submit="addGroup"
            class="group-list__input-container"
            :class="{ 'group-list__input-active': isGroupInputActive }"
          >
            <input
          ...
          <div class="group-list__items" ref="groupContent">
            <transition-group name="group">
              <span
                ...
                :class="{
                  'group-list__item-active': activeGroupIndex == group.id,
                }"
        ...
        <div v-if="groups.length" class="edit-groups">
          <Icon
            ...
            color="#ff6464"
            height="22"
            @click="(isChangeGroupState = true), toggleGroupInputActive()"
          />
          ...
          <transition-group name="list">
            ...
            >
              <span
                ...
                :class="{ 'task-changing': changingTaskId == task.id }"
                >{{ task.title }}</span
              >
              <div class="tasks__item_icons">
                ...
                <Icon
                  ...
                  color="#ff6464"
                  height="22"
                  @click="(changingTaskId = task.id), (isTaskChanging = true)"
                />
  ...
  <div v-else class="msg">
    <div class="container">
      <div class="msg__inner">
        <h3>
          There is no groups!. Create some groups in order to create tasks
        </h3>
      </div>
    </div>
  </div>
